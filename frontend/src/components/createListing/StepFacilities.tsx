...
const StepFacilities = memo(({ facilities, onToggle }: Props) => {
    ...
    const groups: { titleRo: string; titleEn: string; items: { key: keyof Facilities; labelRo: string; labelEn: string; icon: React.ReactNode }[] }[] = [
        { titleRo: "Internet & Parcare", titleEn: "Internet & Parking", items: [
        ...
        { titleRo: "Climă", titleEn: "Climate", items: [
        ...
        { titleRo: "Electrocasnice", titleEn: "Appliances", items: [
        ...
        { titleRo: "Spații & Dotări", titleEn: "Spaces & Amenities", items: [
    ...
    return (
        <Section icon={<StarIcon sx={{ fontSize: 24 }} />}
